...
// Modernized SVG icons
const SpaceshipIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2L15 5H21C21.5523 5 22 5.44772 22 6V18C22 18.5523 21.5523 19 21 19H3C2.44772 19 2 18.5523 2 18V6C2 5.44772 2.44772 5 3 5H9L12 2Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
...
const TerminalToolbar = ({ onNewTab, onOpenSSH, onOpenSettings }) => {
  return (
    <ToolbarContainer>
      <TitleSection>
        <SpaceshipIcon />
        <h2>Spaceflight Terminal</h2>
      </TitleSection>
      
      <ControlsSection>
        <ToolbarButton className="new-tab" onClick={onNewTab} title="New Terminal">
          <PlusIcon />
          New Terminal
        </ToolbarButton>
        
        <ToolbarButton className="ssh" onClick={onOpenSSH} title="SSH Connection">
          <SSHIcon />
          SSH
        </ToolbarButton>
